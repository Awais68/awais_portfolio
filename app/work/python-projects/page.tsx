...
const projects = [
  {
    num: "01",
    caterogy: "Chatbot Application ",
    title: "Chatbot Application",
    description:
      "The Chainlit chatbot application is a software tool designed to interact with users in a conversational manner. It typically includes features for natural language processing, understanding user queries, and providing relevant responses. These applications are widely used in customer support, virtual assistants, and other domains where human-like interaction is beneficial.",
    stack: [{ name: "OpenAI Agent SDK" }, { name: "Gemini API Key" }, { name: "Python" }, { name: "Chainlit" },],
    image: "/assets/images/python1.png",
    live: "https://chatbot-chainlit-gbyv.onrender.com/",
    github: "https://github.com/Awais68/chatbot_chainlit",
  },
  {
    num: "02",
